...
export default function ProgressView({ open, onClose, workouts, equipmentMap = {}, userId = null, initialExercise = null, fromLink = false }) {
  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.header}>
        {selected ? (
          <button className={styles.backBtn} onClick={() => fromLink ? onClose() : setSelected(null)} type="button">
