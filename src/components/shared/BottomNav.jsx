...
function IconHome({ active }) {
  ...
  // Lucide: house
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? 'rgba(245,208,32,0.12)' : 'none'} stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
